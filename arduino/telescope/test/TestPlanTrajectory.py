...
vals = [11.0, 22.22, 23.23,
        ...
        19.0, 38.38, 39.39,
        20.0, 40.40, 41.41]
packet = struct.pack(format_str, 1, 2, 2, 10, *vals)
udp_socket.sendto(packet, (target_address, target_port))
time.sleep(21)
...
vals = [11.0, 22.22, 23.23,
        ...
        19.0, 38.38, 39.39,
        20.0, 40.40, 41.41]
packet = struct.pack(format_str, 1, 2, 4, 10, *vals)
udp_socket.sendto(packet, (target_address, target_port))
vals = [21.0, 42.42, 43.43,
        ...
        29.0, 58.58, 59.59,
        30.0, 60.60, 61.61]
packet = struct.pack(format_str, 1, 3, 4, 10, *vals)
udp_socket.sendto(packet, (target_address, target_port))
vals = [31.0, 62.62, 63.63,
        ...
        39.0, 78.78, 79.79,
        40.0, 80.80, 81.81]
packet = struct.pack(format_str, 1, 4, 4, 10, *vals)
udp_socket.sendto(packet, (target_address, target_port))
time.sleep(41)
